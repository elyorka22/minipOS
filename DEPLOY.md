...
Railway автоматически установит переменную `PORT`. Дополнительные переменные не требуются для базовой работы.
...
Данные хранятся в файле `data/products.json` на сервере Railway. Этот файл создается автоматически при первом запуске.
